...
\section{Work Experience}
    \resumeHeading{NCR Corporation}{Software Engineering Intern}{Atlanta, GA}{May 2022 - Aug 2022 }
        \begin{bullets}
            ...
            \item Working on fleshing out the API endpoints and making the Kubernetes Cluster.
        \end{bullets}
    \sectionsep
...
\section{Skills}
    ...
    \begin{skillList}
        \singleItem{Languages: }{\fontsize{9pt}{10pt} \customRalewayLight Python, Rust, Go, JavaScript, Java, C, C++, C\#, HTML/CSS, Bash, AWK, Solidity}\\
        \singleItem{Web \& App Development:}{\fontsize{9pt}{10pt} \customRalewayLight ReactJS, Express.js, Node.js, Flutter, Ionic Framework, React Native, Socket.IO, Redux, ReactFlow, Web3.js}\\
        ...
        \singleItem{Technologies: }{\fontsize{9pt}{10pt} \customRalewayLight Git, MATLAB, Docker, Postman, \LaTeX, SQL, MongoDB, Redis, Kubernetes}\\
