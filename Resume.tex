...
\section{Education}
    ...
    {\courseWork{\fontsize{9pt}{10pt} \customRalewayLight Data Structure and Algorithms, Honors Discrete Math}} \par
...
\section{Work Experience}
    \resumeHeading{Notitia}{Software Engineer}{Atlanta, GA}{Nov, 2021 - }
        \begin{bullets}
                ...
                \item Optimized the Frontend, Backend and Flask server, cutting time in Frontend by {60\%} and {40\%} in MongoDB and Backend.
        \end{bullets}
    \sectionsep
...
\section{Projects}
    \projectHeading{DeusCL}{https://github.com/xinslu/deusCL}{Rust, Common Lisp}
        \begin{justify}
            \vspace{-1.5ex} \fontsize{10pt}{10pt} \customRalewayLight A Memory-Efficient, Memory-Safe and Fast REPL that implements {Common Lisp} and is built using Rust. Implementing a {Recursive Descent} Parser and building an {Abstract Syntax Tree} to represent code and expressions. Working on implementing a {Garbage Collector}. \par
        \end{justify}
