...
\section{Education}
    \educationHeading{GEORGIA INSTITUTE OF TECHNOLOGY}{Bachelors of Science in Computer Science}{Atlanta, GA}{Aug 2021-Dec 2024} \par
...
\section{Projects}
    ...
    \projectHeading{DeusCL}{https://github.com/xinslu/deusCL}{Rust, Common Lisp}
        \begin{justify}
            \vspace{-1.5ex} \fontsize{10pt}{10pt} \customRalewayLight A Memory-Efficient, Memory-Safe and Fast REPL that implements Common Lisp and is built using Rust. Implemented a Recursive Descent Parser and a visitor pattern system for the evaluator. Working on implementing a Garbage Collector. \par
        \end{justify}
...
\section{Skills}
    ...
    \begin{skillList}
        \singleItem{Languages: }{\fontsize{9pt}{10pt} \customRalewayLight Python, JavaScript, HTML/CSS, Java, C, C++, C\#, Bash, Rust, AWK, Solidity}\\
        ...
        \singleItem{Technologies: }{\fontsize{9pt}{10pt} \customRalewayLight Git, MATLAB, Docker, Postman, \LaTeX, SQL, MongoDB, Redis, Kubernetes, Blockchain}\\
